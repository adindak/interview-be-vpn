...
class PaymentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPaymentDetails = channel.unary_unary(
                '/payment.PaymentService/GetPaymentDetails',
        ...
        self.GetAllPayments = channel.unary_unary(
                ...
                response_deserializer=payment__pb2.PaymentListResponse.FromString,
                )
...
def add_PaymentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetAllPayments': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=payment__pb2.PaymentListResponse.SerializeToString,
            ),
    }
...
class PaymentService(object):
    ...
    def GetPaymentDetails(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/payment.PaymentService/GetPaymentDetails',
    ...
    def GetAllPayments(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/payment.PaymentService/GetAllPayments',
            payment__pb2.Empty.SerializeToString,
            payment__pb2.PaymentListResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
